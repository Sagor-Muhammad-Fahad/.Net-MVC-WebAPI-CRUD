using API_Prctice_6.Repository;
...
namespace API_Prctice_6.Providers
{
    public class AppAuth : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            using(UserRepo repo = new UserRepo())
            {
                ...
                if(user == null)
                {
                    context.SetError("Invalid", "wrong Info");
                }
